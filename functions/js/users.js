...
module.exports = {
    ...
    async getSpotify(user, channel, image = false) {
        ...
        await user.presence.activities.forEach(async (activity) => {
            if (activity.type === 'LISTENING' && activity.name === 'Spotify' && activity.assets !== null) {
                ...
                const spotifyBtns = new Discord.MessageActionRow()
                ...
                if (image === false) {
                    ...
                    .then(buffer => {
                        ...
                        const img = new Discord.MessageAttachment().setFile("assets/spotify.png")
    ...
    async getLastPresence(user, i = 0) {
        if (user.presence == null || user.presence.id === "custom" || user.presence == undefined || user.presence?.activities == undefined) return console.error("No presences")
